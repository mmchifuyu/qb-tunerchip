...
$(document).ready(function(){
    ...
    window.addEventListener('message', function(event){
        ...
        } else if (eventData.action == "setBackground") {
            const element = document.querySelector(".tunerchip-software");
            element.style.backgroundImage = "url('"+eventData.url+"')";
        }
    });
});
...
$(document).on('click', '#save', function(){
    ...
    audio.play();
    console.log($("#boost-slider").val())
    console.log($("#acceleration-slider").val())
    console.log($("#gear-slider").val())
    console.log($("#breaking-slider").val())
    console.log($("#drivetrain-slider").val())
